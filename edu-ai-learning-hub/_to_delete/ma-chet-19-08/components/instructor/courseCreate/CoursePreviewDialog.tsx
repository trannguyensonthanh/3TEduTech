...
interface CoursePreviewDialogProps {
  ...
  formValues: {
    ...
    language: string;
    price: string;
    /* [THÊM 19/08/2026] Phần thân component đã đọc hai trường này (khối hiện
       giá gạch ngang) nhưng khai báo prop lại thiếu. Để `?` vì biểu mẫu chỉ
       điền chúng khi giảng viên bật giảm giá. */
